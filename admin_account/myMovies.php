	        ...
	        <a href="./myMovies.php">
	          <span>
	          	...
	          	<?php
	          		...
	          		$stmt = $link->prepare("SELECT fullname FROM users WHERE userID = ?");
	  ...
	  <?php
	  	...
	  	if($_SERVER["REQUEST_METHOD"] == "POST") {
		    ...
		    while($row = $result->fetch_assoc()) {
		    	...
		    	$st1 = $link->prepare("SELECT ROUND(AVG(rating), 1) AS avg from user_movie_list WHERE movieID = ?");
